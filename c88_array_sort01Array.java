/* We can easily do by few methods-
    ...
    4.  bestter way is to traverse only once and arranging 0s and 1s simultaneously
*/
...
public class c88_array_sort01Array {
    public static void main(String[] args) {
        ...
        scn.close();
        // sort01Array(arr);   //after sorting zero pointer will be at the first one ie. 0s array will be from 0 to z-1 and 1s will be z and arr.length-1
        segregrate0s1s(arr);
    }
