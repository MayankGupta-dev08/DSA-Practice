/* When we have not provided any constructor as in some prev questions, then java provides default constructor without any arguments which initialises int with 0 and String with null, but if we have provided our own constructor then java will use that.
