...
public class c247_btree_printAllAtKLevelDown {
    ...
    public static void printAllAtKLevelDown(Node node, int k) {
        if (node == null || k < 0) {
            return;
        }
        ...
        printAllAtKLevelDown(node.left, k - 1);
        printAllAtKLevelDown(node.right, k - 1);
    }
