...
public class c78_array_secondLargestElementInArray {
    ...
    // easier would have been sorting the array and returning the first element from the last which is not equal to arr[arr.length-1].
    // for this time complexity = O(nlogn) would have been worse.
