package in.co.codeWithMayank.c100_c199;/* INFIX TO POSTFIX
...
public class c172_stack_infixToPostfix {
    ...
    public static String convertInfix2Postfix(String infix) {
    ...
    public static String operation(String v1, String v2, Character optr) {
        return (v1 + v2 + Character.toString(optr));
    }
